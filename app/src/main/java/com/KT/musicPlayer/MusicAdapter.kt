...
import com.made_by_aasho_or_aka.musicPlayer.MusicAdapter.MyHolder
import com.made_by_aasho_or_aka.musicPlayer.databinding.DetailsViewBinding
import com.made_by_aasho_or_aka.musicPlayer.databinding.MoreFeaturesBinding
import com.made_by_aasho_or_aka.musicPlayer.databinding.MusicViewBinding
...
//                        .setBackground(ColorDrawable(0x99000000.toInt()))
        ...
        when{
            ...
            selectionActivity ->{
                ...
                holder.root.setOnClickListener {
                when{
                    StartActivity.search -> sendIntent(ref = "MusicAdapterSearch", pos = position)
