...
import com.made_by_aasho_or_aka.musicPlayer.databinding.FragmentNowPlayingBinding
...
class NowPlaying : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        requireContext().theme.applyStyle(StartActivity.currentTheme[StartActivity.themeIndex], true)
