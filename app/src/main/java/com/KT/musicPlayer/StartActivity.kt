...
import com.made_by_aasho_or_aka.musicPlayer.databinding.ActivityStartBinding
import java.io.File
...
class StartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shuffleBtn.setOnClickListener {
            val intent = Intent(this@StartActivity, PlayerActivity::class.java)
            intent.putExtra("index", 0)
            intent.putExtra("class", "MainActivity")
            startActivity(intent)
        }
        binding.favouriteBtn.setOnClickListener {
            startActivity(Intent(this@StartActivity, FavouriteActivity::class.java))
        }
        binding.playlistBtn.setOnClickListener {
            startActivity(Intent(this@StartActivity, PlaylistActivity::class.java))
        }
        binding.playNextBtn.setOnClickListener {
            startActivity(Intent(this@StartActivity, PlayNext::class.java))
        }
        binding.navView.setNavigationItemSelectedListener{
            when(it.itemId)
            {
                R.id.navFeedback -> startActivity(Intent(this@StartActivity, FeedbackActivity::class.java))
                R.id.navSettings -> startActivity(Intent(this@StartActivity, SettingsActivity::class.java))
                R.id.navAbout -> startActivity(Intent(this@StartActivity, AboutActivity::class.java))
                R.id.navExit -> {
    ...
    private fun initializeLayout(){
        ...
        binding.musicRV.layoutManager = LinearLayoutManager(this@StartActivity)
        musicAdapter = MusicAdapter(this@StartActivity, MusicListMA)
