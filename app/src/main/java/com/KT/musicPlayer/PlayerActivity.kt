...
import com.made_by_aasho_or_aka.musicPlayer.databinding.ActivityPlayerBinding
import com.made_by_aasho_or_aka.musicPlayer.databinding.AudioBoosterBinding
...
class PlayerActivity : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTheme(StartActivity.currentTheme[StartActivity.themeIndex])
...
//Important Function
    private fun initializeLayout(){
        ...
        when(intent.getStringExtra("class")){
            ...
            "MusicAdapterSearch"-> initServiceAndPlaylist(StartActivity.musicListSearch, shuffle = false)
            "MusicAdapter" -> initServiceAndPlaylist(StartActivity.MusicListMA, shuffle = false)
            "FavouriteAdapter"-> initServiceAndPlaylist(FavouriteActivity.favouriteSongs, shuffle = false)
            "MainActivity"-> initServiceAndPlaylist(StartActivity.MusicListMA, shuffle = true)
